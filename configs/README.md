...
- `dataset/`: Hydra config group for dataset providers. Add a new `<name>.yaml` with `_target_` pointing to a subclass of `DatasetProvider`, then launch with `dataset=<name>`.
