"""
src/replm/models/dplm/modules/gvp_transformer_encoder.py

The code is adapted from https://github.com/bytedance/dplm/blob/main/src/byprot/models/dplm/modules/gvp_transformer_encoder.py
