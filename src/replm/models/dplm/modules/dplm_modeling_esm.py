"""
src/replm/models/dplm/modules/dplm_modeling_esm.py

The code is adapted from https://github.com/bytedance/dplm/blob/main/src/byprot/models/dplm/modules/dplm_modeling_esm.py
