"""
src/replm/models/dplm/modules/dplm_adapter.py

The code is adapted from https://github.com/bytedance/dplm/blob/main/src/byprot/models/dplm/modules/dplm_adapter.py
...
from ..utils import NetConfig, get_net
